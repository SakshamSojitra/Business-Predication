...
import { transformBackendAnalysis, setStoredAnalysis } from "@/lib/analysis/client"
import {
  Building2,
  Users,
  DollarSign,
...
export default function CompanyInputPage() {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      const normalized = transformBackendAnalysis(analysis)
      if (!normalized) {
        throw new Error("Analysis normalization failed")
      }

      setStoredAnalysis(normalized)
